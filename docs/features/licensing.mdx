...
description: How Sencho Pro licensing works, including trials, activation, and subscription management.
---

Sencho uses an open-core model. The **Community** tier is free forever with unlimited nodes. **Pro** unlocks advanced features through two plans: **Skipper** for solo operators and **Admiral** for teams.
